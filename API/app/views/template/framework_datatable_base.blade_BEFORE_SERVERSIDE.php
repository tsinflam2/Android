...
<html>
    <head>
		...
		// Saves grid edit changes in cookie
		function grid_edit_save() {
			var changed = false;
			var changed_mk_data_obj;

			if (cookieExists('gridchanges')) {
				changed_mk_data_obj = getCookie('gridchanges');
				console.log('cookie exist, use old');
			} else {
				changed_mk_data_obj = new Object();
				console.log('cookie not exist, created new');
			}
			...
			/*
				...
				console.log('temply save: ');
				console.log(changed_mk_data_obj);
				setCookie('gridchanges', changed_mk_data_obj, 1);
			...
			$('td[id=group4]').hide();
				...
				//console.log($('form[id=17]').children().eq(2));
				
				//uncomment following when ready
    ...
    <body onload="documentLoaded()" class="skin-blue">
                            ...
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">
	                                    ...
	                                    <button type="button" id="bar_gridedit" class="btn btn-default " onclick="grid_edit()"><i class="fa fa-edit">&nbsp;</i>Grid Edit</button>
	                                    <button type="button" id="bar_archive" class="btn btn-danger" onclick="archive_selected()"><i class="fa fa-archive">&nbsp;</i>Archive</button>
	                                    </td>
										...
										<td id="group4" style="display:none">
											<button type="button" id="bar_gridedit_save" class="btn btn-success" onclick="grid_edit_submit()"><i class="fa fa-save">&nbsp;</i>Save</button>
                                ...
                                <div class="box-body table-responsive">
									...
									<table id="dtmain" class="table table-bordered table-hover" style="display:none">
                                        <thead>
                                            <tr id="dtheader">
		...
		$(document).ready(function() {
			if (window.location.href.indexOf('origin=') > -1) {
				...
				$('span#backButton').html('<button class="btn btn-success"  data-toggle="tooltip" title="" data-original-title="Return" onclick="hide_modify();">&nbsp;<i class="fa fa-mail-reply"></i>&nbsp;</button>');
			}
		});
		</script>
